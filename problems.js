 ...
 * disableFns - An array of function identifiers to be disabled before the code is run. It should take the following form: [{obj : Array.prototype, prop : "forEach"}, {obj : Array.prototype, prop : "some"}, ...]. These functions will be reenabled once the code is run.
 */
